...
async def amireallyalive(alive):
    ...
    output = (
        ...
        f"╚══════════╬════╬══════════╝ \n"
        f"🔰 : [RestXSky Repo](https://github.com/OhMyQueen/Geez-UserBot)\n👥 : [RΞST-𝗧𝗘𝗔𝗠](t.me/FlicksSupport)\n👤 : [𝗢𝗪𝗡𝗘𝗥](t.me/geludsinibos)\n"
    )
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
...
async def redis(alive):
    ...
    output = (
        ...
        f"╭═───────╼⌘╾───────═ \n"
        f"┃[𝗥𝗲𝗽𝗼](https://github.com/OhMyQueen/Geez-UserBot)  |  [𝗦𝘂𝗽𝗽𝗼𝗿𝘁](t.me/GeezSupportGroup)  |  "
        f"[Support](https://t.me/FlicksSupport)\n"
        f"╰═──────╼═⌘═╾───────═")
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
